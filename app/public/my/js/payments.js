        ...
        $.ajax({
            ...
            success : function(data) {
                ...
                if(data.total_debt == 0){
                    ...
                    $('#date_pay').prop('disabled', true)
                    $('#importe').prop('disabled', true)
                    $('#btn-form-new-pay').prop('disabled', true)
            ...
            success: function(data)
            {
                ...
                $.each(data, function( i, value ) {
                   ...
                   if(value.detail != null){
                    name_detail = value.product.name+ ' - '+value.detail
                   }else{
                    name_detail = value.product.name
                   }
                    $('#buy').append(
                        `
                        <tr id='item`+value.id+`' >
                            <td> `+formatDate(value.date_sale)+` </td>
