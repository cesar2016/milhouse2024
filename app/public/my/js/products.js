...
$(function () {
                ...
                $('#products').append(
                    ...
                    <tbody class='text-success'>
                        <tr>
                            ...
                            <td> `+ (data.brand_product == null ? '' : data.brand_product.name ) +` </td>
                            <td>
    ...
    /// Sheet Excel import
    // # NUEVO INSERT --
    $(document).on('submit','#form-sheet-excel-import',function(e){
        ...
        $.ajax({
            type: 'POST',
            url: URI_API+'import_sheet_excel',
            data: formData,
            contentType: false,
            cache: false,
            processData:false,
            ...
            //url: URI_API+'products/import_sheet_excel',
