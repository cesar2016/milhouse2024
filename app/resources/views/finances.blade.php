                ...
                <div class="form-row align-items-center">
                    ...
                    <div class="col-auto">
                        ...
                        <div class="input-group mb-2">
                            ...
                            <input type="text" value="" class="form-control" name='day' id="day" placeholder="Ej: 01">
                        </div>
                    </div>
                    ...
                    <div class="col-auto">
                        ...
                        <div class="input-group mb-2">
                            ...
                            <input type="text" value="{{ date('Y') }}" class="form-control" name='age' id="age" placeholder="año">
                        </div>
                    </div>

                    <div class="d-grid gap-2 col-12 mx-auto">
                        <button type="submit" class="btn btn-block btn-primary mb-2">Enviar</button>
                    </div>
                </div>
            </form>
