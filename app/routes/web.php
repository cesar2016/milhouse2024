...
use App\Http\Controllers\dowloadSheets\Eje_productsController;
...
// # Esta es la RUTA que se usa para ALTA de user, DESCOMENTAR
...
Route::post('/products/import_sheet_front', [ProductController::class, 'import_excel_products'])->name('products_import_excel_products');
...
// # Dowload de Modelos de Excel
Route::get('/dowload_eje_products', [Eje_productsController::class, 'dowload_eje_products'])->name('dowload_eje_products');
