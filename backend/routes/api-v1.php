...
Route::get('testing',[TestingController::class, 'testing'])->name('api.v1.testing');
...
Route::post('import_sheet_excel',[ProductController::class, 'import_sheet_excel'])->name('api.v1.products.import_sheet_excel');
Route::post('import_sheet_excel_clients',[ClientController::class, 'import_sheet_excel_clients'])->name('api.v1.products.import_sheet_excel_clients');
